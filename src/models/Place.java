...
public enum Place {
	...
	QUERY(1400, 50, "Consulta", "/images/consulta1.png"), 
	QUOTE(1400, 600, "Cita","/images/citas1.png"), 
	EMERGENCY_QUERY(1000, 300, "Emergencia", "/images/emergencia1.png"), 
	NORMAL_QUERY(500, 100, "General", "/images/general1.png"), 
	PHARMACY(800, 800, "Farmacia", "/images/farmacia1.png"), 
	BILLING(300, 500, "facturacion", "/images/facturacion1.png"), 
	INIT(1900, 400, "Entrada", "/images/init.png"),
	EXIT(-200, 400, "Salida", "/images/exit.png");
